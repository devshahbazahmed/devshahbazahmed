...
![My Skills](https://skillicons.dev/icons?i=next,react,ts,js, python,tailwind,nodejs,express,mongodb,postgresql,prisma,html,css,sass,git,github,vercel,vite,vscode,postman,discord,npm,notion)
